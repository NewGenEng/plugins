...
| `bossfight` | [Bossfight](bossfight/) | Cursor | Developer Tools | A graph-based builder, verifier, and blind-critic loop for taking agent work past a concrete quality bar. |
